...
while petla:
    ...
    if wybor == 1:
        ...
        h = int(input("Wpisz wysokość: "))
        pole =  matematyka.Figury(a, b, h)
        obwod =  matematyka.Obwody(a, b, h)
        pole.rownoleglobok()
